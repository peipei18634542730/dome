...
![](E:\笔记\面试总结\imgs/InkedJVMXParam_LI.jpg)
...
![](E:\笔记\面试总结\imgs/GCbq.png)

![](E:\笔记\面试总结\imgs/GCbz.png)

### 标记清除

![](E:\笔记\面试总结\imgs/GCbq.png)

![](E:\笔记\面试总结\imgs/GCbq2.png)

### 复制算法

![](E:\笔记\面试总结\imgs/GCfz.png)

![](E:\笔记\面试总结\imgs/GCfz2.png)
...
![](E:\笔记\面试总结\imgs/GCqi.png)

连线表示可以搭配使用，红叉表示不推荐一同使用，比如新生代用`Serial`，老年代用`CMS`。

![](E:\笔记\面试总结\imgs/GCqi2.png)
